...
constexpr sf::Vector2f OVERLAY_DESC_TEXT_POS = {
    OVERLAY_PADDING + OVERLAY_TEXT_PADDING, OVERLAY_PADDING + OVERLAY_TEXT_PADDING
};
...
constexpr float OVERLAY_UPGRADE_BTN_BASE_POS_Y =
        (OVERLAY_PADDING * 2.f) + OVERLAY_DESC_FIELD_HEIGHT + (OPTION_SIZE.y / 2.f) + OVERLAY_UPGRADE_BTN_OUT_THICKNESS;
...
constexpr float INFO_HP_POS_X = INFO_PADDING;
constexpr float INFO_HP_POS_Y = WINDOW_HEIGHT - INFO_PADDING;
constexpr sf::Color INFO_HP_BORDER_COLOR = {0, 204, 109, 255};
constexpr int INFO_HP_BORDER_WIDTH = 2;
